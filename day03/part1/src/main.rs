...
// The idea is to convert the input into a 2D array of chars
// Then iterate over each cells
// If cells is '.' or symbol, do nothing
// If cells is a number, check the surrounding cells
// Check if the cell is adjacent to a symbol directly or through another number
// If yes, do nothing
// If no, replace the cell with a .

// Then keep all remaining numbers and sum them
